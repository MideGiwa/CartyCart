...
const Features = () => {
  return (
    <div className="features row">
      <div className="col-md-3 feature-div f-1">
      ...
      <div className="col-md-3 feature-div f-2">
      ...
      <div className=" col-md-3 feature-div f-3">
      ...
      <div className=" col-md-3 feature-div f-4">
